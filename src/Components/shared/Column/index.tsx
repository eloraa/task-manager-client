        ...
        <div ref={provided.innerRef} {...provided.draggableProps} {...provided.dragHandleProps}>
          <div className="bg-coconut-faded mt-15 p-4 rounded-md">
            ...
            <button
              ...
              className="border-rose-600 border-b border-dashed flex items-center gap-1 text-rose-600 font-grotesk text-xs font-semibold mt-6 transition-colors hover:bg-rose-600/15 relative"
            >
